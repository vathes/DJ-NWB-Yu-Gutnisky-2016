...
class Probe(dj.Lookup):
    ...
    class Channel(dj.Part):
        ...
        ---
        -> Probe.Shank
        channel_x_pos:  float   # ap position relative to the tip of the probe (m)
        channel_y_pos:  float   # ml position relative to the tip of the probe (m)
        channel_z_pos:  float   # dv position relative to the tip of the probe (m)
        """
